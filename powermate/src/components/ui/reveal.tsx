...
const kinds: Record<RevealKind, { hidden: Record<string, number | string>; shown: Record<string, number | string> }> = {
 ...
 * the goal is varied, intentional motion, not one fade applied to everything.
 */
